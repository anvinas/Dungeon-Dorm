          ...
          <div className="flex flex-col flex-1 justify-center gap-5">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center w-full gap-5">
                <ItemState onClick={()=>{}} size="3vw" itemSize="2vw"   display="bottom" bg="gray-800" itemData={itemsSeperatedObj.keys[0].item} showQuantity={false} quantity={itemsSeperatedObj.keys[0].quantity}/>
                <ItemState onClick={()=>{}} size="3vw" itemSize="2vw"  display="bottom" bg="gray-800" itemData={itemsSeperatedObj.keys[1].item} showQuantity={false} quantity={itemsSeperatedObj.keys[1].quantity}/>
                <ItemState onClick={()=>{}} size="3vw" itemSize="2vw"  display="bottom" bg="gray-800" itemData={itemsSeperatedObj.keys[2].item} showQuantity={false} quantity={itemsSeperatedObj.keys[2].quantity}/>
                <ItemState onClick={()=>{}} size="3vw" itemSize="2vw"  display="bottom" bg="gray-800" itemData={itemsSeperatedObj.keys[3].item} showQuantity={false} quantity={itemsSeperatedObj.keys[3].quantity}/>
                <ItemState onClick={()=>{}} size="3vw" itemSize="2vw"   display="bottom" bg="gray-800" itemData={itemsSeperatedObj.keys[4].item} showQuantity={false} quantity={itemsSeperatedObj.keys[4].quantity}/>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-1 justify-center">
              ...
              {/* Top Items */}
              <div className="flex items-center justify-center w-full gap-5">
                <ItemState onClick={()=>{}} size="5vw" itemSize="3vw" display="bottom" bg="gray-800" itemData={itemsSeperatedObj.potions[0].item} showQuantity={true} quantity={itemsSeperatedObj.potions[0].quantity}/>
              </div>

              {/* Bottom Items */}
              <div className="flex items-center justify-center w-full gap-5">
                <ItemState onClick={()=>{}} size="5vw" itemSize="3vw"  display="bottom" bg="gray-800" itemData={itemsSeperatedObj.potions[1].item} showQuantity={true} quantity={itemsSeperatedObj.potions[1].quantity}/>
                <ItemState onClick={()=>{}} size="5vw" itemSize="3vw"  display="bottom" bg="gray-800" itemData={itemsSeperatedObj.potions[2].item} showQuantity={true} quantity={itemsSeperatedObj.potions[2].quantity}/>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between w-full gap-5 flex-0">
              ...
              <div className="flex flex-col items-center justify-center" >
                ...
                {itemsSeperatedObj.weapons.length>0 && <ItemState onClick={()=>{}} showQuantity={false}quantity={1} size="4vw" itemSize="3vw" display="top" bg="teal-500" itemData={itemsSeperatedObj.weapons[0].item}/>}
          ...
          <div className="flex-1 bg-gray-700 rounded-t-lg p-2 gap-3 flex flex-col">
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="flex-1 flex items-center justify-center">
                <img
                  className={`${styles.pixelImage} w-[60%] max-w-full object-contain`}
              ...
              <div className="w-full bg-gray-600 p-2 rounded-md flex-1  flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-5">
                  {itemShopList.map((itemData,i)=>{
                    ...
                    return(
                      <ItemState key={`item_${i}`} onClick={()=>setPurchasingItem(itemData)} showQuantity={false} quantity={1} size={"3vw"} itemSize="2vw" bg="gray-700" display="bottom"  itemData={itemData}/>
                    )
                  })}
                </div>
              </div>
...
const ItemState = ({itemData,display,bg,size,itemSize,quantity,showQuantity,onClick}:{
  ...
  if(!itemData || !itemData.imageURL || itemData.itemType=="fake") return(
    <div className="relative flex flex-col justify-center items-center">
      <div className={`h-[${size}] w-[${size}] bg-${bg} rounded-[50%] p-3 flex items-center justify-center hover:bg-gray-900 cursor-pointer`}>
  ...
  return(
    <div onClick={()=>onClick()} onMouseEnter={()=>setIsHover(true)} onMouseLeave={()=>setIsHover(false)} className="relative flex flex-col justify-center items-center">
      {isHover && <div className={`absolute ${display}-[-10%] translate-y-[${display=="top"?"-":""}100%] text-center text-white font-bold capitalize text-lg z-5`}>{itemData.name}</div>}
      {showQuantity &&
        <div className={`absolute ${display=="top"?"bottom":"top"}-[-5%] left-[70%] p-3 flex items-center justify-center border-1 border-black text-center text-white font-bold capitalize text-xs z-5 bg-blue-600 rounded-[50%] h-[1vw] w-[1vw]`}>
          <div>x{quantity}</div>
        </div>
      }
      <div className={`h-[${size}] w-[${size}] bg-${bg} rounded-[50%] p-3 flex items-center justify-center hover:bg-gray-900 cursor-pointer`}>
          <img
            className={`w-[${itemSize}] h-[${itemSize}] object-contain`}
